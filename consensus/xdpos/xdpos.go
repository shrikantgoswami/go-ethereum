...
// XDPoS is the delegated-proof-of-stake consensus engine proposed
type XDPoS struct {
...
func (c *XDPoS) verifyHeader(chain consensus.ChainReader, header *types.Header, parents []*types.Header) error {
...
// from.
func (c *XDPoS) verifySeal(chain consensus.ChainReader, header *types.Header, parents []*types.Header) error {
	return nil
}
